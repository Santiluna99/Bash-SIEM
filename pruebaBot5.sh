...
if [ -n "$FAILED_LOGINS" ]; then
    ...
    ALERT_MESSAGE="Lord Senior Santiago, se detectaron los siguientes intentos de inicio de sesión fallidos en el archivo de registro de autenticación ($LOG_FILE) a las siguientes horas: $TIME_STAMPS"
